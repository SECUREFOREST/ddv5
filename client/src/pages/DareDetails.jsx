    ...
    <div className="max-w-md sm:max-w-xl lg:max-w-2xl w-full mx-auto mt-16 bg-gradient-to-br from-[#232526] via-[#282828] to-[#1a1a1a] border border-[#282828] rounded-2xl p-0 sm:p-8 mb-8 overflow-hidden">
      ...
      {dare?.proof && (dare.proof.text || dare.proof.fileUrl) ? (
        <div className="flex flex-col items-center mb-4">
          <div className="relative group cursor-pointer w-48 h-48 flex items-center justify-center bg-neutral-800 rounded-lg border border-neutral-700 overflow-hidden" onClick={() => setShowProofModal(true)}>
          ...
          <button className="mt-2 text-primary underline hover:text-primary-contrast transition-colors shadow-lg" onClick={() => setShowProofModal(true)}>View Full Proof</button>
        </div>
      ) : (
        <div className="flex flex-col items-center mb-4">
      ...
      <div className="sticky bottom-0  py-4 flex flex-col sm:flex-row gap-3 justify-center items-center z-10 border-t border-neutral-800">
        {canAccept && (
          <button className="w-full sm:w-auto bg-success text-success-contrast rounded px-4 py-2 font-bold text-base hover:bg-success-dark transition-colors focus:outline-none focus:ring-2 focus:ring-success-contrast flex items-center gap-2 justify-center text-lg shadow-lg" onClick={dare ? handleAcceptDare : undefined} disabled={acceptLoading || !dare}>
            {acceptLoading ? 'Accepting...' : 'Accept & Perform This Dare'}
          </button>
        )}
        {canSubmitProof && !inCooldown && !atSlotLimit && !roleRestricted && (
          <button className="w-full sm:w-auto bg-primary text-primary-contrast rounded px-4 py-2 font-bold text-base hover:bg-primary-contrast hover:text-primary transition-colors focus:outline-none focus:ring-2 focus:ring-primary-contrast flex items-center gap-2 justify-center text-lg shadow-lg" onClick={() => setShowProofModal(true)}>
            Submit Proof of Completion
          </button>
        )}
        {isPerformerParticipant && dare.status !== 'rejected' && (
          <button className="w-full sm:w-auto bg-danger text-danger-contrast rounded px-4 py-2 font-bold text-base hover:bg-danger-dark transition-colors focus:outline-none focus:ring-2 focus:ring-danger-contrast flex items-center gap-2 justify-center text-lg shadow-lg" onClick={() => setShowRejectModal(true)}>
            Reject Dare
          </button>
        )}
      </div>
      ...
      <Modal open={showRejectModal} onClose={() => setShowRejectModal(false)} title="Reject Dare" role="dialog" aria-modal="true">
        <form onSubmit={handleReject} className="space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-2">
            <button type="button" className="bg-gray-200 text-gray-800 rounded px-4 py-2 font-semibold text-sm hover:bg-gray-300 shadow-lg" onClick={() => setShowRejectModal(false)}>
              Cancel
            </button>
            <button type="submit" className="bg-red-500 text-white rounded px-4 py-2 font-semibold text-sm hover:bg-red-600 shadow-lg" disabled={rejecting}>
      ...
      <Modal open={showProofModal} onClose={() => setShowProofModal(false)} title="Submit Proof of Completion" role="dialog" aria-modal="true">
        <form onSubmit={handleProofSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-2">
            <button type="button" className="bg-gray-200 text-gray-800 rounded px-4 py-2 font-semibold text-sm hover:bg-gray-300 shadow-lg" onClick={() => setShowProofModal(false)}>
              Cancel
            </button>
            <button type="submit" className="bg-primary text-white rounded px-4 py-2 font-semibold text-sm hover:bg-primary-dark shadow-lg" disabled={proofLoading}>
      ...
      <Modal open={showReportModal} onClose={() => setShowReportModal(false)} title="Report Comment" role="dialog" aria-modal="true">
        <form onSubmit={handleReportSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-2">
            <button type="button" className="bg-gray-200 text-gray-800 rounded px-4 py-2 font-semibold text-sm hover:bg-gray-300 shadow-lg" onClick={() => setShowReportModal(false)}>
              Cancel
            </button>
            <button type="submit" className="bg-red-500 text-white rounded px-4 py-2 font-semibold text-sm hover:bg-red-600 shadow-lg" disabled={reportLoading}>
      ...
      <Modal open={showAppealModal} onClose={() => setShowAppealModal(false)} title="Appeal Rejected Dare" role="dialog" aria-modal="true">
        <form onSubmit={handleAppealSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-2">
            <button type="button" className="bg-neutral-700 text-neutral-100 rounded px-4 py-2 font-semibold text-sm hover:bg-neutral-900 shadow-lg" onClick={() => setShowAppealModal(false)}>
              Cancel
            </button>
            <button type="submit" className="bg-primary text-primary-contrast rounded px-4 py-2 font-semibold text-sm hover:bg-primary-dark shadow-lg" disabled={appealLoading}>
      ...
      <Modal open={editCommentId !== null} onClose={() => setEditCommentId(null)} title="Edit Comment" role="dialog" aria-modal="true">
        <form onSubmit={handleEditSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-2">
            <button type="button" className="bg-gray-200 text-gray-800 rounded px-4 py-2 font-semibold text-sm hover:bg-gray-300 shadow-lg" onClick={() => setEditCommentId(null)}>
              Cancel
            </button>
            <button type="submit" className="bg-primary text-white rounded px-4 py-2 font-semibold text-sm hover:bg-primary-dark shadow-lg" disabled={editLoading}>
      ...
      <Modal open={showModerateModal} onClose={() => setShowModerateModal(false)} title="Moderate/Hide Comment" role="dialog" aria-modal="true">
        <form onSubmit={handleModerateSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-2">
            <button type="button" className="bg-gray-200 text-gray-800 rounded px-4 py-2 font-semibold text-sm hover:bg-gray-300 shadow-lg" onClick={() => setShowModerateModal(false)}>
              Cancel
            </button>
            <button type="submit" className="bg-yellow-500 text-white rounded px-4 py-2 font-semibold text-sm hover:bg-yellow-600 shadow-lg" disabled={moderateLoading}>
