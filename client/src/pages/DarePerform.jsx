...
export default function DarePerform() {
  ...
  return (
    <div className="max-w-lg w-full mx-auto mt-16 bg-[#222] border border-[#282828] rounded-none shadow-sm p-[15px] mb-5">
      ...
      {!consented ? (
        <form onSubmit={e => { e.preventDefault(); handleConsent(); }} className="space-y-4">
          ...
          <button type="submit" className="bg-primary text-white rounded px-4 py-2 font-semibold text-sm hover:bg-primary-dark disabled:opacity-50" disabled={loading || !consentChecked}>
