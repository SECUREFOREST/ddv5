...
const allCompletedDares = [
  ...
  return (
    <div className="max-w-md sm:max-w-2xl lg:max-w-4xl w-full mx-auto mt-16 bg-gradient-to-br from-[#232526] via-[#282828] to-[#1a1a1a] border border-[#282828] rounded-2xl shadow-2xl p-0 sm:p-8 mb-8 overflow-hidden">
      ...
      <Tabs
        tabs={[
          { label: 'All Dares', content: <div>{/* All Dares tab content here */}</div> },
          { label: 'Perform Dare', content: <div>{/* Perform Dare tab content here */}</div> },
          { label: 'Demand Dare', content: <div>{/* Demand Dare tab content here */}</div> },
          { label: 'Switch Games', content: <div>{/* Switch Games tab content here */}</div> },
        ]}
