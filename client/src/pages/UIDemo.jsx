...
export default function UIDemo() {
  ...
  return (
    <div className="max-w-3xl mx-auto mt-12 bg-neutral-800 rounded-lg shadow p-8">
      <h1 className="text-2xl font-bold text-center mb-8 text-primary">UI Primitives Demo</h1>
      {/* Button */}
