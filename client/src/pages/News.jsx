          ...
          <div className="space-y-6">
            {filteredNews.length === 0 ? (
              ...
              filteredNews.map((item) => (
                <article
                  key={item.id}
                  className={`bg-gradient-to-br from-neutral-900/80 to-neutral-800/60 rounded-2xl p-6 border ${getPriorityColor(item.priority)} shadow-xl hover:shadow-2xl transition-all duration-300`}
                >
