...
export default function DareShare() {
  ...
  return (
    <div className="w-full mx-auto mt-16 bg-gradient-to-br from-[#232526] via-[#282828] to-[#1a1a1a] border border-[#282828] rounded-2xl p-0 sm:p-6 mb-8 overflow-hidden relative">
      {/* Progress/Accent Bar */}
