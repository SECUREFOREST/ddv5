...
const Landing = () => {
  ...
  return (
    <div className="max-w-md sm:max-w-xl lg:max-w-2xl w-full mx-auto mt-20 bg-gradient-to-br from-[#232526] via-[#282828] to-[#1a1a1a] border border-[#282828] rounded-2xl p-0 sm:p-8 mb-12 overflow-hidden">
      <Helmet>
        <title>Deviant Dare | Social Dares, Challenges & Games Community</title>
        <meta name="description" content="Deviant Dare: Social dares, challenges, and games. Create, perform, and share dares with friends. Join the ultimate dare community online." />
        <meta property="og:title" content="Deviant Dare | Social Dares, Challenges & Games Community" />
        <meta property="og:description" content="Deviant Dare: Social dares, challenges, and games. Create, perform, and share dares with friends. Join the ultimate dare community online." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://deviantdare.com/" />
        <meta property="og:image" content="/logo.svg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Deviant Dare | Social Dares, Challenges & Games Community" />
        <meta name="twitter:description" content="Deviant Dare: Social dares, challenges, and games. Create, perform, and share dares with friends. Join the ultimate dare community online." />
